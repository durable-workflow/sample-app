...
default_server_image="durableworkflow/server:0.2.170"
default_cli_version="0.1.55"
default_python_sdk_version="0.4.72"
default_workflow_version="2.0.0-alpha.174"
