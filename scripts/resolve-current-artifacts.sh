...
default_server_image="durableworkflow/server:0.2.146"
default_cli_version="0.1.47"
default_python_sdk_version="0.4.63"
default_workflow_version="2.0.0-alpha.166"
default_waterline_version="2.0.0-alpha.56"
