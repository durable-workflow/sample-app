    ...
    directions = [
        {
            ...
            "workflow_type": "polyglot.php-to-python.binary-type-roundtrip",
            "task_queue": PHP2PY_QUEUE,
            "workflow_runtime": "php",
            "activity_runtime": "python",
            "workers": [
                {"task_queue": PHP2PY_QUEUE, "runtime": "php", "workflow_type": "polyglot.php-to-python.binary-type-roundtrip"},
                {"task_queue": PHP2PY_QUEUE, "runtime": "python", "activity_type": "polyglot.php-to-python.binary-echo"},
            ],
        },
        {
            "direction": "python_to_php",
            "workflow_type": "polyglot.python-to-php.binary-type-roundtrip",
            "task_queue": PY_QUEUE,
            "workflow_runtime": "python",
            "activity_runtime": "php",
            "workers": [
                {"task_queue": PY_QUEUE, "runtime": "python", "workflow_type": "polyglot.python-to-php.binary-type-roundtrip"},
                {"task_queue": PY2PHP_QUEUE, "runtime": "php", "activity_type": "polyglot.python-to-php.binary-echo"},
            ],
        },
        {
            "direction": "rust_to_python",
            "workflow_type": "polyglot.rust-to-python.binary-type-roundtrip",
            "task_queue": RUST_QUEUE,
            "workflow_runtime": "rust",
            "activity_runtime": "python",
            "workers": [
                {"task_queue": RUST_QUEUE, "runtime": "rust", "workflow_type": "polyglot.rust-to-python.binary-type-roundtrip"},
                {"task_queue": PHP2PY_QUEUE, "runtime": "python", "activity_type": "polyglot.rust-to-python.binary-echo"},
            ],
        },
        {
            "direction": "python_to_rust",
            "workflow_type": "polyglot.python-to-rust.binary-type-roundtrip",
            "task_queue": PY_QUEUE,
            "workflow_runtime": "python",
            "activity_runtime": "rust",
            "workers": [
                {"task_queue": PY_QUEUE, "runtime": "python", "workflow_type": "polyglot.python-to-rust.binary-type-roundtrip"},
                {"task_queue": TO_RUST_QUEUE, "runtime": "rust", "activity_type": "polyglot.python-to-rust.binary-echo"},
            ],
        },
        {
            "direction": "rust_to_php",
            "workflow_type": "polyglot.rust-to-php.binary-type-roundtrip",
            "task_queue": RUST_QUEUE,
            "workflow_runtime": "rust",
            "activity_runtime": "php",
            "workers": [
                {"task_queue": RUST_QUEUE, "runtime": "rust", "workflow_type": "polyglot.rust-to-php.binary-type-roundtrip"},
                {"task_queue": PY2PHP_QUEUE, "runtime": "php", "activity_type": "polyglot.rust-to-php.binary-echo"},
            ],
        },
        {
            "direction": "php_to_rust",
            "workflow_type": "polyglot.php-to-rust.binary-type-roundtrip",
            "task_queue": TO_RUST_QUEUE,
            "workflow_runtime": "php",
            "activity_runtime": "rust",
            "workers": [
                {"task_queue": TO_RUST_QUEUE, "runtime": "php", "workflow_type": "polyglot.php-to-rust.binary-type-roundtrip", "worker_id": "php-to-rust-workflow-worker"},
