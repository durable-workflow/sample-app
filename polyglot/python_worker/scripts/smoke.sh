...
: "${DURABLE_SERVER_IMAGE:=durableworkflow/server:0.2.116}"
: "${DURABLE_WORKFLOW_CLI_VERSION:=0.1.38}"
: "${DURABLE_WORKFLOW_CLI_PIN:=durable-workflow/cli:0.1.38}"
: "${DURABLE_WORKFLOW_PHP_SDK_PIN:=durable-workflow/workflow:2.0.0-alpha.146@89075600489300b12b9a3ed2fdf4f855a24d4a0f}"
