...
: "${DURABLE_SERVER_IMAGE:=durableworkflow/server:0.2.170}"
: "${DURABLE_WORKFLOW_CLI_VERSION:=0.1.55}"
...
if [ -z "${DURABLE_WORKFLOW_WATERLINE_VERSION:-}" ] && [ -n "${DURABLE_WORKFLOW_WATERLINE_PIN:-}" ]; then
