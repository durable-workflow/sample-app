...
final class PolyglotComposeContractTest extends TestCase
{
    ...
    public function test_polyglot_smoke_installs_published_cli_and_configures_waterline(): void
    {
        ...
        $this->assertSame(
            'eba8c8ae388a942537181a0b6463b0300c5aedee',
    ...
    public function test_polyglot_artifact_resolver_keeps_pinned_tuple_explicit(): void
    {
        ...
        $this->assertSame('durableworkflow/server:0.2.448', $assignments['DURABLE_SERVER_IMAGE'] ?? null);
        $this->assertSame('0.2.448', $assignments['DURABLE_SERVER_VERSION'] ?? null);
        ...
        $this->assertSame('2.0.0-alpha.210', $assignments['DURABLE_WORKFLOW_PHP_SDK_VERSION'] ?? null);
        $this->assertSame(
            'durable-workflow/workflow:2.0.0-alpha.210',
            $assignments['DURABLE_WORKFLOW_PHP_SDK_PIN'] ?? null,
        );
