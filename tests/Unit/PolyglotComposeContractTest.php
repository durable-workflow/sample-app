...
final class PolyglotComposeContractTest extends TestCase
{
    ...
    public function test_polyglot_smoke_installs_published_cli_and_configures_waterline(): void
    {
        ...
        $this->assertSame(
            'aca98956fe6e2af21dc6976a14c92b345c28e3fc',
    ...
    public function test_polyglot_artifact_resolver_keeps_default_current_tuple_at_committed_floor(): void
    {
        ...
        $this->assertSame('durableworkflow/server:0.2.521', $assignments['DURABLE_SERVER_IMAGE'] ?? null);
        $this->assertSame('0.2.521', $assignments['DURABLE_SERVER_VERSION'] ?? null);
        ...
        $this->assertSame('2.0.0-alpha.226', $assignments['DURABLE_WORKFLOW_PHP_SDK_VERSION'] ?? null);
