...
final class PolyglotComposeContractTest extends TestCase
{
    ...
    public function test_polyglot_server_artifact_defaults_to_current_public_image(): void
    {
        ...
        $this->assertStringContainsString('durableworkflow/server:0.2.185', $smokeShell);
        ...
        $this->assertStringContainsString('durableworkflow/server:0.2.185', $smokeDriver);
    ...
    public function test_polyglot_smoke_installs_published_cli_and_configures_waterline(): void
    {
        ...
        $this->assertStringContainsString('DURABLE_WORKFLOW_CLI_VERSION=0.1.64', $dockerfile);
        $this->assertStringContainsString('ARG DURABLE_WORKFLOW_PYTHON_SDK_VERSION=0.4.78', $dockerfile);
        ...
        $this->assertStringContainsString('ARG DURABLE_WORKFLOW_PYTHON_SDK_VERSION=0.4.78', $pythonWorkflowDockerfile);
        $this->assertStringContainsString(
            'durable-workflow==${DURABLE_WORKFLOW_PYTHON_SDK_VERSION}',
        ...
        $this->assertStringContainsString('DURABLE_WORKFLOW_CLI_VERSION:=0.1.64', $smokeShell);
        $this->assertStringContainsString('DURABLE_WORKFLOW_PYTHON_SDK_VERSION:=0.4.78', $smokeShell);
        ...
        $this->assertSame(
            '0bf68a977471bc3730cc3a6a3d48bd199e6a0891',
        ...
        $this->assertSame(
            '0ccfc4c57ea4fe271ae96ae1933ebe75e5cd8864',
        ...
        $this->assertSame(
            '${DURABLE_WORKFLOW_PYTHON_SDK_VERSION:-0.4.78}',
    ...
    private function assertServerImageDefaultIsCurrent(mixed $image): void
    {
        ...
        $this->assertTrue(
            version_compare($matches['version'], '0.2.185', '>='),
            sprintf('Expected durableworkflow/server default >= 0.2.185, got %s.', $image),
        );
    }
