...
final class PolyglotComposeContractTest extends TestCase
{
    ...
    public function test_polyglot_smoke_installs_published_cli_and_configures_waterline(): void
    {
        ...
        $this->assertStringContainsString("ARG DURABLE_WORKFLOW_WATERLINE_VERSION=2.0.0-alpha.91\n", $phpDockerfile);
        ...
        $this->assertSame(
            '17028c7653f8c8eeb4872ffd053cc1beb80c789e',
        ...
        $this->assertSame(
            '${DURABLE_WORKFLOW_PHP_SDK_VERSION:-2.0.0-alpha.204}',
        ...
        $this->assertSame(
            '${DURABLE_WORKFLOW_WATERLINE_VERSION:-2.0.0-alpha.91}',
    ...
    public function test_polyglot_artifact_resolver_keeps_pinned_tuple_explicit(): void
    {
        ...
        $this->assertSame('2.0.0-alpha.204', $assignments['DURABLE_WORKFLOW_PHP_SDK_VERSION'] ?? null);
        $this->assertSame(
