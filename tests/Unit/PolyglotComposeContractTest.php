...
final class PolyglotComposeContractTest extends TestCase
{
    ...
    public function test_polyglot_smoke_installs_published_cli_and_configures_waterline(): void
    {
        ...
        $this->assertSame(
            '8a870df6435e4a21a06daa720d38f02ac55b7594',
    ...
    public function test_polyglot_artifact_resolver_keeps_default_current_tuple_at_committed_floor(): void
    {
        ...
        $this->assertSame('durableworkflow/server:0.2.491', $assignments['DURABLE_SERVER_IMAGE'] ?? null);
        $this->assertSame('0.2.491', $assignments['DURABLE_SERVER_VERSION'] ?? null);
        ...
        $this->assertSame('2.0.0-alpha.223', $assignments['DURABLE_WORKFLOW_PHP_SDK_VERSION'] ?? null);
