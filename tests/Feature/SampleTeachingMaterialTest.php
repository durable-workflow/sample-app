...
class SampleTeachingMaterialTest extends TestCase
{
    ...
    public function test_full_conformance_harness_is_public_and_names_required_surfaces(): void
    {
        ...
        $this->assertStringContainsString('default_server_image="durableworkflow/server:0.2.206"', $artifactResolver);
        ...
        $this->assertStringContainsString('default_workflow_version="2.0.0-alpha.187"', $artifactResolver);
